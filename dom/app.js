...
// // to change the style of the anchor tags inside the box 
...
// // practise question asnwers

// let para1 = document.createElement('p');
// para1.innerText = "hey my self abhishek mishra";
// document.querySelector('body').append(para1);
// para1.classList.add('red');


// let para2 = document.createElement('h3');
// para2.innerText = "hey my self abhishek mishra";
...
// h1.innerText = "I am inside the div!";
// p.innerText = "me to !"
...
// for ( btn of btns){
//     btn.onclick = sayHello;    // for multiple buttons and do not use parenthesis here after sayHello
// }
...
// // btn.onclick = sayHello;  for a single button
...
// // });                               but you cant see the alert because the form is getting submitted and the page is getting refreshed immediately
...
console.log(max);
>>>>>>> 4be67561bcab93f7df6b8e166f55d5732f77a950
